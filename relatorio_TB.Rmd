...
\hline
Efetividade do exoma     & EfEx          & 0.23           & Ref PTC             &  \\
Efetividade do array     & EfArr         & 0.1            & Sagoo 2009          &  \\
Efetividade do cariótipo & EfCa          & 0.03           & Exemplo de valor!!! &  \\
Custo do exoma           & CEx           & \$7.500,00     & Fleury              &  \\
Custo do array           & CArr          & \$4.054,00     & Fleury              &  \\
Custo do cariótipo       & CCa           & \$1.390,00     & Exemplo de valor!!! & 
\end{tabular}
\end{table}
...
\centering
% left, bottom, right, top
\includegraphics[width=\textwidth, trim = 12mm 8mm 12mm 4mm, clip]{arvore_dados.pdf}
\caption{Árvore de decisão para diagnóstico de pacientes com deficiência intelectual, tomando como exame de primeira linha a análise de cariótipo (indicado por "cariótipo"), microarray ou sequenciamento completo do exoma (indicado por "exoma"). As probabilidades associadas a cada ramo estão indicadas em verde; os custos e efetividades (pacientes diagnosticados em 100) finais ao longo de um caminho estão em vermelho e azul escuro, respectivamente; a razão entre custo esperado e efetividade esperada está em azul claro. A decisão de menor custo-eftividade está contida numa caixa azul.}
...
gridExtra::grid.arrange(
  ...
  labs(title = "Cariótipo", x = "", y = "densidade estimada ") + 
  theme_classic(), 
  ...
  ggdistribute::stat_density_ci(ci_width = 0.95) + 
  scale_x_continuous(labels = scales::dollar_format("R$")) + 
  labs(title = "Microarray", x = "", y = "densidade estimada ") + 
  theme_classic(),
  ...
  ggdistribute::stat_density_ci(ci_width = 0.95) + 
  scale_x_continuous(labels = scales::dollar_format("R$")) + 
  labs(title = "Exoma", x = "", y = "densidade estimada ") + 
  theme_classic(), 
